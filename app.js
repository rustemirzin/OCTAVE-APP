...
/* ============================================================
   ...
   ============================================================ */
const ME = {
  id:'me', name:'Александр Петров', rank:'Золотой участник', role:'Капитан', city:'Москва',
  rating:870,
...
const PEOPLE = [
  ...
  { id:'smirnova', name:'Екатерина Смирнова', role:'CEO', city:'Москва', field:'Маркетинг · Стратегия',
  ...
  { id:'nikitin', name:'Максим Никитин', role:'Технологический эксперт', city:'Таллин', field:'IT · Продукты',
    ...
    tags:['IT','AI','Продукты'] },
  { id:'sokolov', name:'Игорь Соколов', role:'Предприниматель', city:'Москва', field:'Производство · Опт',
  ...
  { id:'lebedeva', name:'Мария Лебедева', role:'Маркетинг-директор', city:'Москва', field:'Маркетинг · PR',
...
const EVENTS = [
  { id:'e1', theme:'dinner', title:'Бизнес-ужин O.C.T.A.V.E.', city:'Москва', loc:'Москва, Сити', date:'15 мая, 19:00',
  ...
  { id:'e2', theme:'strategy', title:'Стратегическая сессия Капитанов', city:'Москва', loc:'Москва, Офис OCTAVE', date:'22 мая, 14:00',
  ...
  { id:'e5', theme:'city', title:'Мастермайнд «Рост x10»', city:'Москва', loc:'Москва, Сити', date:'2 апреля, 19:00',
...
const CHATS = [
  ...
  { id:'c4', name:'Капитаны Москвы', last:'Дмитрий: Новый участник в группе', time:'12 мая', unread:0, type:'group', members:14,
    msgs:[
...
const ACHIEVEMENTS = [
  ...
  { ic:'trophy', name:'Топ-10 рейтинга', sub:'Москва, Q2', got:true },
...
const FORUM = {
  my:{ id:'fg3', name:'Форум-группа №3', captain:'Александр Петров', mentor:'Игорь Соколов',
       members:8, cap:8, meetDate:'16 мая, 19:00', meetLoc:'Москва, Офис OCTAVE',
